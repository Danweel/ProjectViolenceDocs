...
Important: GitHub automatically links commits to issues if you include #123 in the commit message. No hook needed for the linking itself! The hook just enforces the habit.
Keywords that trigger auto-closing:
